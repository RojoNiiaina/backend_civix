...
SECRET_KEY = 'django-insecure-f2z63j5mx&&@sm9etn&96tjok@l-$6u=hdu3#ls*jlz+ct%r(6'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=1),   # ex: 1 heure
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://192.168.42.7:3000",
    "http://192.168.42.7:8081",
    ...
    "exp://192.168.42.41:8001",
    "http://192.168.42.41:8000",
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '',
        'HOST': '127.0.0.1',
        'PORT': '3306',  # ou 3307 si vous avez changé le port
    }
}
